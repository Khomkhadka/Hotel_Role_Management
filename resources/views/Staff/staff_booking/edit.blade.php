<x-staff-layout>
    ...
    <div class="bg-gray-100 min-h-screen">
        <div class="bg-white w-full p-8 rounded-lg shadow-lg">
            ...
            <form action="{{ route('staff_bookings.update', $booking->id) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="booked_date" value="{{ old('booked_date', $booking->booked_date) }}"
                    ...
                    <div>
                        ...
                        <input type="date" name="checkin" id="checkin"
                            value="{{ old('checkin', $booking->checkin) }}" class="w-full px-3 py-2 border rounded"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="checkout" id="checkout"
                            value="{{ old('checkout', $booking->checkout) }}" class="w-full px-3 py-2 border rounded"
                            required>
                    </div>
                ...
                <div>
                    ...
                    <textarea name="note" class="w-full px-3 py-2 border rounded" required>{{ old('note', $booking->note) }}</textarea>
                </div>
