<x-hotel-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{ route('hotel_bookings.index') }}" class="bg-slate-700 text-sm rounded-md text-white px-3 py-2">
                Back
            </a>
        </div>
    </x-slot>
    ...
    <div class="bg-gray-100 min-h-screen">
        <div class="bg-white w-full p-8 rounded-lg shadow-lg">
            ...
            <form action="{{ route('hotel_bookings.store') }}" method="POST" class="space-y-4"
