<x-hotel-layout>
    <x-slot name="header">
        ...
        <a href="{{ route('hotel_staffs.index') }}" class="bg-slate-700 text-sm rounded-md text-white px-3 py-2">Back</a>
       </div>
    </x-slot>
...
<div class="bg-white w-full p-8 rounded-lg shadow-lg">
    ...
    <form action="{{ route('hotel_staffs.store') }}" method="POST" class="space-y-4">
        @csrf
