<x-hotel-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{ route('hotel_packages.index') }}"
    ...
    <div class="bg-gray-100 min-h-screen">
        ...
        <div class="bg-white w-full p-8 rounded-lg shadow-lg">
            ...
            <form action="{{ route('hotel_packages.store') }}" method="POST" class="space-y-4">
                @csrf
                ...
                <div>
                    ...
                    <textarea name="description" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-black"
